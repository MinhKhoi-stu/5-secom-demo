export enum QUERY_KEY {
  ...
  FIND_ALL_ADMIN_RIGHT = "FIND_ALL_ADMIN_RIGHT",
  FIND_ONE_ADMIN_RIGHT = "FIND_ONE_ADMIN_RIGHT",
  FIND_ALL_RESOURCE = "FIND_ALL_RRESOURCE",
  ...
  FIND_ALL_FACILITY = "FIND_ALL_FACILITY",
  ...
  STATISTIC_ALL_FACILITY = "STATISTIC_ALL_FACILITY",
